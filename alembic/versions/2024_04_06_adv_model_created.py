...
Revision ID: a7246e09f475
Revises: 994b19020120
Create Date: 2024-04-06 11:14:44.135015
...
revision: str = 'a7246e09f475'
down_revision: Union[str, None] = '994b19020120'
...
def upgrade() -> None:
    ...
    sa.Column('group', sa.Enum('SELLING_ADV', 'BUYING_ADV', 'SERVICE_ADV', name='group'), nullable=False),
